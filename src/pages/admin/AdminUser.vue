  ...
  <div class="admin-user">
    ...
    <div class="form-edit" v-if="ui.formVisible">
      <form @submit.prevent="createOrUpdate">
        ...
        <div class="input-field">
          <el-input type="text" placeholder="手机号码" v-model="form.phone"/>
          <div class="error-list">
        ...
        <div class="input-field">
          <el-input type="text" placeholder="邮箱" v-model="form.mail"/>
          <div class="error-list">
        ...
        <div class="input-field">
          <el-input type="text" placeholder="密码" v-model="form.password" />
          <div class="error-list">
    ...
    <div class="table-user">
      <el-table :data="list" style="width: 100%" max-height="500">
        <el-table-column fixed prop="nickname" label="昵称" width="80"></el-table-column>
